...
class NanoscopeFile(object):
    ...
    """
    supported_versions = ['0x05120130', '0x05120000']
    ...
    def amplitude_error(self):
        """
        Return the amplitude error image if it exists, else ``None``.
        """
    ...
    def _read_image_data(self, file_object, image_type):
        ...
        """
        if image_type not in ['Height', 'AmplitudeError', 'Phase']:
